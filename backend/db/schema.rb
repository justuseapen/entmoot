...
ActiveRecord::Schema[7.2].define(version: 2026_01_23_213126) do
  ...
  create_table "notification_preferences", force: :cascade do |t|
    ...
    t.string "check_in_frequency", default: "daily", null: false
    t.index ["check_in_frequency"], name: "index_notification_preferences_on_check_in_frequency"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "onboarding_challenge"
    t.jsonb "onboarding_skipped_steps", default: [], null: false
    t.jsonb "calendar_waitlist", default: {}, null: false
